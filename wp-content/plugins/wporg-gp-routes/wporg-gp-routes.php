 ...
 * Description: Provides custom routes like <code>/locale</code> or <code>/stats</code> for translate.classicpress.org.
 * Version:     2.0
 * Author:      WordPress.org
 * Author URI:  http://classicpress.org/
...
if ( ! class_exists( '\WordPressdotorg\Autoload\Autoloader', false ) ) {
	include __DIR__ . '/vendor/classicpressdotorg/autoload/class-autoloader.php';
}
