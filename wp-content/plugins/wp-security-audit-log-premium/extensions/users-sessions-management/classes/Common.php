...
class WSAL_User_Management_Common {
	...
	public function update_sessions_transient( $occ, $type, $data ) {
		...
		if ( is_multisite() ) {
			$transient = 'wsal-users_sessions_' . get_current_blog_id();
		}
	...
	/**
	 * Multiple Sessions Notify Setting.
	 *
	 * @deprecated 3.2.4
	 *
	...
	/**
	 * Multiple Blocked Sessions Notify Setting.
	 *
	 * @deprecated 3.2.4
	 *
	 * @param boolean $status - Status.
	...
	/**
	 * Get Multiple Sessions Notify Setting.
	 *
	 * @deprecated 3.2.4
	 */
	...
	/**
	 * Get Multiple Blocked Sessions Notify Setting.
	 *
	 * @deprecated 3.2.4
	 */
	 ...
	 * @param int    $userblog_id – Blog ID of the user.
	...
	public function DestroyUserSession( $user_id, $token_hash ) {
		...
		if ( is_multisite() ) {
			$delete_fn( 'wsal-users_sessions_' . get_current_blog_id() );
		} else {
